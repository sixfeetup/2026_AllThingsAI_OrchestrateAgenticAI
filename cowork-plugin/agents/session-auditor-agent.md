---
name: session-auditor-agent
description: Process auditor that maintains a living timeline of the review session. Use to audit what was done, by which agent, when, and what it produced — tracking gaps and decisions.
