---
name: document-eval-agent
description: Experienced document analyst for evaluating contracts against structured criteria. Use when performing criteria-based evaluation of loaded documents.
...
1. Confirm the contract is loaded (documents must be loaded via `/load-document`).
