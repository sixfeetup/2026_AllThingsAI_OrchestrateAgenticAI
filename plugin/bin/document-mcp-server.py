...
PARSE_SCRIPT = SKILLS_DIR / "load-document" / "document-parse.py"
LOAD_SCRIPT = SKILLS_DIR / "load-document" / "document-load.py"
SEARCH_SCRIPT = SKILLS_DIR / "search-document" / "document-search.py"
DEFAULT_DOCUMENT = PLUGIN_DIR / "assets" / "1-RFP 20-020 - Original Documents.zip"
