...
**Decision**: Use Postgres as the only supported demo database, and cut over to a separately loaded Postgres state after any live ingest or ETL proof step.
...
## Decision 4: Visual explainers as first-class artifacts
...
## Decision 5: Repo-local Codex and MCP behavior
